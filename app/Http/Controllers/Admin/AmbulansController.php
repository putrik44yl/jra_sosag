...
class AmbulansController extends Controller
{
    ...
    {
        $anggota = Anggota::all();
        return view('admin.ambulans.create', compact('anggota'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.ambulans.index')->with('success', 'Data ambulans berhasil ditambahkan.');
    }

    public function show($id)
    {
        $ambulans = Ambulans::with('anggota')->findOrFail($id);
        return view('admin.ambulans.show', compact('ambulans'));
    }
    ...
    public function edit($id)
    {
        ...
        $anggota = Anggota::all();
        return view('admin.ambulans.edit', compact('ambulans', 'anggota'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.ambulans.index')->with('success', 'Data ambulans berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.ambulans.index')->with('success', 'Data ambulans berhasil dihapus.');
    }
}
