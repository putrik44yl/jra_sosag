...
class PenggunaAmbulansController extends Controller
{
    ...
    public function index()
    {
        ...
        // kirim ke view
        return view('pengguna_ambulans.index', compact('pengguna'));
    }
    ...
    public function create()
    {
        ...
        return view('pengguna_ambulans.create', compact('ambulans', 'anggota', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pengguna_ambulans.index')->with('success', 'Data pengguna ambulans berhasil ditambahkan.');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('pengguna_ambulans.show', compact('penggunaAmbulans'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('pengguna_ambulans.edit', compact('penggunaAmbulans', 'ambulans', 'anggota', 'users'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('pengguna_ambulans.index')->with('success', 'Data pengguna ambulans berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('pengguna_ambulans.index')->with('success', 'Data pengguna ambulans berhasil dihapus.');
    }
}
