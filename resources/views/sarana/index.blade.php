        ...
        <tbody>
            @forelse ($sarana as $data)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('sarana.show', $data->id_sarana) }}" class="btn btn-icon btn-primary" title="Detail">
                            <i class="bx bx-show"></i>
                        </a>
                        <a href="{{ route('sarana.edit', $data->id_sarana) }}" class="btn btn-icon btn-warning" title="Edit">
                            <i class="bx bx-edit"></i>
                        </a>
                        <form action="{{ route('sarana.destroy', $data->id_sarana) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
