...
<div class="container">
    ...
    <div class="mt-3">
        <a href="{{ route('admin.pengguna_sarana.index') }}" class="btn btn-secondary">Kembali</a>
        <a href="{{ route('admin.pengguna_sarana.edit', $pengguna->id_pengguna) }}" class="btn btn-warning">Edit</a>
        <form action="{{ route('admin.pengguna_sarana.destroy', $pengguna->id_pengguna) }}" method="POST" class="d-inline">
            @csrf
            @method('DELETE')
